...
export default function Page() {
  ...
  return (
    <main className="relative secondary-bg overflow-x-hidden">
      ...
      {/* Main Content */}
      <div ref={mainContentRef} className="relative z-30 bg-white overflow-x-hidden">
        <div className="w-full flex flex-col items-center relative !pt-0 z-10">
          <div className="flex mx-auto w-full">
            <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-16 py-24 max-md:px-6 max-sm:py-16 max-sm:gap-10 w-full h-full flex flex-col justify-between relative !py-0 z-10">
              <NavbarBlack />
            </div>
          </div>
