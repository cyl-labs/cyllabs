...
const PricingTable: React.FC = () => {
          ...
          <div className="flex justify-center">
            <motion.div
              ...
              className={`w-6 h-6 rounded-full ${
                isEnterprise ? "bg-orange-500" : "bg-orange-500"
  ...
  const renderMobileFeatureValue = (
    value: string | boolean,
    isEnterprise: boolean = false
  ) => {
    if (typeof value === "boolean") {
    ...
    return (
      <motion.span variants={itemVariants} className="text-sm font-medium mr-2">
        {value}
      </motion.span>
    );
  };
  ...
  return (
    ...
    >
      {/* Header */}
      <motion.div variants={headerVariants} className="text-left mb-8 md:mb-12">
        <motion.h1
        ...
        >
          We believe this should be accessible to all businesses, no matter the
          size.
        </motion.p>
      </motion.div>
          ...
          <div className="grid grid-cols-4 gap-4 lg:gap-8 xl:gap-12 mb-6">
            ...
            {plans.map((plan, index) => (
              ...
              >
                ...
                <motion.p
                  className="text-gray-200 text-xs lg:text-sm"
                  initial={{ opacity: 0, x: -10 }}
                  animate={{ opacity: 1, x: 0 }}
            ...
            >
              {features.map((feature, featureIndex) => {
                ...
                return (
                  ...
                  >
                    <div className="font-semibold text-xs sm:text-sm pr-4 text-gray-800">
                      {feature.name}
                    </div>
